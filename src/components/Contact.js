    ...
    <>
      <div className="jumbotron jumbotron-fluid">
        <div className="container">
          ...
          <p className="lead">This is the contact section</p>
          <p>
            With this page, you will be able to contact me on different type of
            social media, and see where I am located in real-time
          </p>
        </div>
      </div>
